...
const TopNav = () => {
  return (
        ...
        <a href="#" class="flex items-center">
            <img src={logo} class="mr-3 h-6 sm:h-11" alt="Flowbite Logo" />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HIS</span>
        </a>
        <div class="flex items-center md:order-2">
            ...
            <img class="w-8 h-8 rounded-full" src={image} alt="user photo" />
            </button>
        ...
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
            <a href="#" class="block pb-3 font-bold text-3xl pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Health Care Information System</a>
            </li>
            {/* <li>
