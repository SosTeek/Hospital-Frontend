...
<div id="large-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                                <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <form class="px-6 py-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                            <div>
                                                <label for="test" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hospital Name</label>
